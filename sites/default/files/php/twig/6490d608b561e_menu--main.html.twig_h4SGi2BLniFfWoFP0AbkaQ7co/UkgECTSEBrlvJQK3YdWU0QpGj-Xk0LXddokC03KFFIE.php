...
/* themes/custom/law_theme/templates/navigation/menu--main.html.twig */
class __TwigTemplate_fe7e751eee85e7443b4578c748a3c650 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
$context["item"], "url", [], "any", false, false, true, 54), "toString", [], "method", false, false, true, 54), 54, $this->source)))];
        ...
        ";
                        ...
                        echo "\" class=\"";
                        $context['_parent'] = $context;
                        $context['_seq'] = twig_ensure_traversable(($context["link_classes"] ?? null));
                        foreach ($context['_seq'] as $context["_key"] => $context["class"]) {
                            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($context["class"], 61, $this->source), "html", null, true);
                            echo " ";
                        }
  ...
  ";
    ...
    {
        return "themes/custom/law_theme/templates/navigation/menu--main.html.twig";
    }
    ...
    {
        return array (  149 => 65,  142 => 63,  124 => 61,  119 => 59,  114 => 58,  111 => 57,  109 => 54,  108 => 53,  107 => 52,  106 => 51,  105 => 50,  104 => 49,  99 => 47,  97 => 44,  96 => 43,  95 => 42,  94 => 41,  93 => 40,  92 => 39,  90 => 38,  85 => 37,  81 => 35,  75 => 33,  72 => 32,  69 => 31,  66 => 30,  51 => 29,  44 => 27,  41 => 22,  39 => 21,);
    }
...
{% macro menu_links(items, attributes, menu_level) %}
  ...
  {% if items %}
    ...
    {% for item in items %}
      ...
      <li{{ item.attributes.addClass(classes) }}>
        ...
        {% else %}
          <a href=\"{{ item.url }}\" class=\"{% for class in link_classes %}{{ class }} {% endfor %}\"><span>{{ item.title }}</span></a>
        {% endif %}
      </li>
    {% endfor %}
    </ul>
  {% endif %}
{% endmacro %}
", "themes/custom/law_theme/templates/navigation/menu--main.html.twig", "/var/www/test.com/themes/custom/law_theme/templates/navigation/menu--main.html.twig");
    }
    
    public function checkSecurity()
    {
        static $tags = array("import" => 21, "macro" => 29, "if" => 31, "for" => 37, "set" => 39);
        static $filters = array("escape" => 33, "join" => 53, "clean_class" => 54);
