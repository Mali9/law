...
class __TwigTemplate_59c77a81c6ffc57b83110927ef9f0a94 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    {
        return new Source("{# inline_template_start #}<span class=\"status\">{% if status %}{{ \"Published\"|t }}{% else %}{{ \"Not published\"|t }}{% endif %}</span>{% if outdated %} <span class=\"marker\">{{ \"outdated\"|t }}</span>{% endif %}", "__string_template__effa4b21c84e5814674ebf2c307b6458", "");
    }
