      ...
      success: function (data) {
        ...
        if (data.field_judicial_benefits) {
          ...
          for (let index = 0; index < data.field_judicial_benefits.length; index++) {
            ...
            if (element != "") {
              text += "<p class='field_judicial_benefits'><span class='tag tag-cloud-functions'>" + element + "</span></p>";
        ...
        if (data.field_regulations_and_circulars) {
          ...
          for (let index = 0; index < data.field_regulations_and_circulars.length; index++) {
            ...
            if (element != "") {
              text += "<p class='field_regulations_and_circulars'><span class='tag tag-cloud-functions'>" + element + "</span></p>";
        ...
        if (data.field_distinctive_grounds) {
          ...
          for (let index = 0; index < data.field_distinctive_grounds.length; index++) {
            ...
            if (element != "") {
              text += "<p class='field_distinctive_grounds'><span class='tag tag-cloud-functions'>" + element + "</span></p>";
        ...
        if (data.field_improper_administrative) {
          ...
          for (let index = 0; index < data.field_improper_administrative.length; index++) {
            ...
            if (element != "") {
              text += "<p class='field_improper_administrative'><span class='tag tag-cloud-functions'>" + element + "</span></p>";
            }
          }
        ...
        if (data.body1) {
          ...
          for (let index = 0; index < data.body1.length; index++) {
            ...
            if (element != "") {
              text += "<p class='body1'><span class='tag tag-cloud-functions'>" + element + "</span></p>";
        ...
        if (data.field_legal_grounds) {
          ...
          for (let index = 0; index < data.field_legal_grounds.length; index++) {
            ...
            if (element != "") {
              text += "<p class='field_legal_grounds'><span class='tag tag-cloud-functions'>" + element + "</span></p>";
        ...
        if (data.field_negatives) {
          ...
          for (let index = 0; index < data.field_negatives.length; index++) {
            ...
            if (element != "") {
              text += "<p class='field_negatives'><span class='tag tag-cloud-functions'>" + element + "</span></p>";
        ...
        if (data.field_challenges_faced) {
          ...
          for (let index = 0; index < data.field_challenges_faced.length; index++) {
            ...
            if (element != "") {
              text += "<p class='field_challenges_faced'><span class='tag tag-cloud-functions'>" + element + "</span></p>";
